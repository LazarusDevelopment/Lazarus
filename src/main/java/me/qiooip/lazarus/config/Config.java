...
public class Config {
    ...
    public static boolean ABILITIES_DENY_USAGE_DISTANCE_ENABLED;
    public static int ABILITIES_DENY_USAGE_DISTANCE_BLOCKS;
    ...
    public Config() {
        ...
        FACTION_STUCK_ALLOWED_MOVEMENT_RADIUS = config.getInt("FACTION_STUCK.ALLOWED_MOVEMENT_RADIUS");
        ...
        ABILITIES_DENY_USAGE_DISTANCE_ENABLED = abilitiesFile.getBoolean("DENY_USAGE_DISTANCE.ENABLED");
        ABILITIES_DENY_USAGE_DISTANCE_BLOCKS = abilitiesFile.getInt("DENY_USAGE_DISTANCE.BLOCKS");
