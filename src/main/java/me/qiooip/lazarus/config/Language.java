...
public class Language {
    ...
    public Language() {
        ...
        ABILITIES_ANTI_TRAP_STAR_TARGET_ACTIVATED = language.getString("ABILITIES.ANTI_TRAP_STAR.TARGET_ACTIVATED");
        ABILITIES_ANTI_TRAP_STAR_TARGET_TELEPORTED = language.getString("ABILITIES.ANTI_TRAP_STAR.TARGET_TELEPORTED");
        ABILITIES_ANTI_TRAP_STAR_PLAYER_TELEPORTED = language.getString("ABILITIES.ANTI_TRAP_STAR.PLAYER_TELEPORTED");
        ABILITIES_ANTI_TRAP_STAR_CANNOT_USE = language.getString("ABILITIES.ANTI_TRAP_STAR.CANNOT_USE");
